...
You can add files in meta-tabs, themes and plugins. Files do not work with public forms right now and they do not support any additional attributes.
...
forms:
  fields:
    myfilefield:
      type: file
      description: Maximum size of files is X MB.
```
