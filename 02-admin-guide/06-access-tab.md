...
In the access tab, you can activate and configure access restrictions for the website or individual pages. Please note that session cookies are used for all frontend visitors to handle page restrictions.
