...
![Screenshot of an article in the Kixote AI interface](media/live/kixote-ai-interface.webp){.center loading="lazy" width="820" height="540"}

You will find two sub-tabs:

* **Article:** In this tab, you can find the current article in Markdown and the prompt input below.
* **Prompts:** In this tab, you can see the predefined prompts and save your own prompts.
...
* **Prompt input**: Below the article, you can add a prompt in the prompt input field. Press the button or the Enter key to send the prompt.
* **Prompt selection**: Below the prompt input field, you have a list of predefined prompts. Click on a prompt to add it to the prompt input field. You can manage the predefined prompts in the Prompts tab.
...
* **Focus**: Mark a text and click the focus button if you want to edit or replace only a specific passage in the article. You can also wrap text manually with the tags ``.
* **Store**: When you are done editing, you can store the article with the store button at the bottom of the article.
...
Kixote will use the default model that has been defined in the AI tab of the system settings. You can select another model in the info tab of Kixote. The selected model will be stored in your browser storage and overwrite the default model.

![Screenshot of the model selection in Kixote](media/live/kixote-model-select.webp){.center loading="lazy" width="820" height="518"}
...
* Click the small close button at the top right of Kixote.
